  ...
  $total=0;
    ...
    <tr>
      ...
      <td><form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <input type="number" name="update_quantity" min="1"  value="0" >
...
<?php echo "<h style='font-size: 24px;'>Total Amount= $total</h>"; ?>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <h5> If Cash On delivary Then Put 0Tk in bkash Field</h5>
      <div class="input-group form-group">
      <input type="hidden" name="totalprice" value="<?php echo $total['totalprice']; ?>">
